...
# add label title
lbltitle = ttk.Label(text='Our Title Goes Here', font=(('Aral'),22))
...
chvar.set(0) # set to 0 (zero) - means checked
...
# create radio button
# to get value from our radio button - in cthe callback function
